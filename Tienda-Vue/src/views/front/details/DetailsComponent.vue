            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" 
                        :src="url+'img/products/'+data.img" alt="..." /></div>
                    <div class="col-md-6">
                        <div class="small mb-1">SKU: BST-498</div>
                        <h1 class="display-5 fw-bolder">{{ data.name }}</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">${{ data.price * 1.20 }}</span>
...
export default{
    ...
    created() {
        ...
        axios.get(process.env.VUE_APP_URL+"products/"+this.$route.params.slug).then(res=>{
